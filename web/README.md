...
in a letter's timeline and `eth_getLogs` cannot find them at all. The explorer's
...
calldata must really name this letter — and the revert reason is decoded by
...
re-hashes the bytes and compares them to what the letter stored. Someone
